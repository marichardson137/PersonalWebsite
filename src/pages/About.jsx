        ...
        <div className="w-full h-full mb-10">
            <div className="w-full p-4 gap-4 flex flex-col justify-center items-center overflow-hidden max-w-[800px] mx-auto">
                <div className="p-2 z-10 flex flex-col items-center sm:items-start text-2xl sm:text-3xl lg:text-4xl">
                    <h1 className="font-semibold lg:py-2 text-slate-100 text-4xl lg:text-5xl">
                        Who am I?
                    </h1>
                    <p className="sm:ml-4 mt-4 text-slate-300 sm:text-lg md:text-xl text-center sm:text-left">
                        I'm a recent graduate from <span className="text-slate-200 font-semibold">North Carolina State University</span>. 
